...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GOAL,
                        VALID_HEIGHT, VALID_AGE, VALID_GENDER, VALID_DEADLINE, VALID_PAID, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_GOAL, VALID_HEIGHT, VALID_AGE, VALID_GENDER, VALID_DEADLINE, VALID_PAID, VALID_TAGS);
    ...
    public void toModelType_invalidHeight_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GOAL,
                        INVALID_HEIGHT, VALID_AGE, VALID_GENDER, VALID_DEADLINE, VALID_PAID, VALID_TAGS);
    ...
    public void toModelType_nullHeight_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GOAL,
                        null, VALID_AGE, VALID_GENDER, VALID_DEADLINE, VALID_PAID, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_GOAL, VALID_HEIGHT, VALID_AGE, VALID_GENDER, VALID_DEADLINE, VALID_PAID, invalidTags);
