...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPaid("true").withBodyfat("18.5").withSession("WEEKLY:MON-0800-0900").withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withPaid("true").withBodyfat("20.0").withSession("WEEKLY:TUE-0900-1000")
            .withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withHeight("180").withWeight("80").withAge("28").withGender("male").withDeadline("2025-12-31")
            .withPaid("true").withBodyfat("22.0").withSession("WEEKLY:WED-1000-1100").build();
